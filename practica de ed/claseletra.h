...
class Letra {
char letra;
int numPalabras; // número de palabras en dicha letra
Palabra *palabras; // tabla dinámica de objetos de tipo Palabra de esa letra
public:
...
// elimina la tabla dinámica de palabras, junto con sus significados                    SI
};
